...
/**
  ...
  ******************************************************************************
  * @attention
  * Debugger OpenOCD enabled. For this, the syscalls.c are exlcuded from the
  * project, including some debugger changes in projects settings (see Udemy tr)
  *
...
/* USER CODE BEGIN PFP */
void initialise_monitor_handles(void); //for debugging enable OpenOCD
